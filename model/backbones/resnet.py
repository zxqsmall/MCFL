...
from model.backbones.attention_blocks import CBAMLayer
"""
    url of the pretrained model's parameters 
"""
model_urls = {
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, cbam=None, last_conv_stride=2):
        self.inplanes = 64
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], cbam, stride=last_conv_stride)
    ...
    def _make_layer(self, block, planes, blocks, cbam, stride=1):
        downsample = None
        ...
        layers = [block(self.inplanes, planes, stride=stride, cbam=cbam, downsample=downsample)]
...
def resnet50(pretrained=False, last_conv_stride=2):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], last_conv_stride=last_conv_stride)
